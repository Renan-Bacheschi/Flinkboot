...
- **[flinkboot-test] Thread-Safe Collecting Sink**: Added `CollectingSink<T>` to collect elements emitted by Flink streams during local tests, with support for parallel sink subtasks.
